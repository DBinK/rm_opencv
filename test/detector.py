...
class Detector:
    ...
    def is_light(self, light):
        ...
        angle_ok = light.calculate_tilt_angle() < self.l['max_angle'] 
        angle_ok = True
...
if __name__ == '__main__':
    ...
    detector = Detector(bin_thres=100, color=RED, light_params=light_params, armor_params=armor_params)
